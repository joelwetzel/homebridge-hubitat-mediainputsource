...
const platformName = 'Hubitat-MakerAPI-HDMI-Switch';
...
function HE_ST_Platform(log, config, api) {
    ...
    if (config['logFile']) {
        if (config['logFile'].enabled) {
            ...
            logFileSettings.file = config['logFile'].file || "homebridge-hubitat-mediainputsource.log";
        ...
        logFileSettings.file = "homebridge-hubitat-mediainputsource.log";
